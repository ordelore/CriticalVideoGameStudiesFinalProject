...
class HelpScreen:
	def __init__(self, scale):
		...
		self.helpTextAfter = "Whether or not you think you won against the beast, the world pays you no attention. In fact, this demonstration of courage has taken energy away from you, but the world is not interested in helping you recover. It is up to you to decide how you want to approach your recovery."
